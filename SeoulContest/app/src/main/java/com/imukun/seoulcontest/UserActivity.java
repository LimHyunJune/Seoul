...
public class UserActivity extends AppCompatActivity {
    ...
    @BindView(R.id.ll_fvroute)
    LinearLayout fvroute;
    ...
    @OnClick({R.id.ll_logout ,R.id.ll_fvpcroom, R.id.ll_pwchange, R.id.ll_account,R.id.open,R.id.ll_fvroute})
    public void  OnClick(View v){
        if(v.equals(logout)){
            ...
            Intent intent =new Intent(UserActivity.this, OSSActivity.class);
            startActivity(intent);
            finish();
        }
        else if(v.equals(fvroute)){
            Intent intent =new Intent(UserActivity.this, List2Activity.class);
            startActivity(intent);
            finish();
        }
