...
public class RecyclerViewAdapter2 extends RecyclerView.Adapter<RecyclerViewAdapter2.ItemViewHolder> {
...
//넘어온 데이터를 담을 객체형 Arraylist를 선언.
    ...
    @NonNull
    @Override
    public RecyclerViewAdapter2.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
// LayoutInflater를 이용하여 전 단계에서 만들었던 item.xml을 inflate 시킵니다.
// return 인자는 ViewHolder 입니다.


        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listitem, parent, false);
        return new RecyclerViewAdapter2.ItemViewHolder(view);
...
//메인에서 RecyclerView를 바인딩하고 어댑터에 연결 시켰다면 어뎁터에서는 Recycler뷰에 들어갈 Item xml을 //Adapter에 연결 시킴. 따라서 리사이클러 뷰와 아이템 xml을 연결시킴.
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapter2.ItemViewHolder holder, int position) {
